function shape_classification_iterative_distance_coeff_var_clustering(data)
...
if isempty(input_values)~=1
    ...
    for i = 1:length(coeff_var)        
        ...
        [classes,size_classes{i}] = shape_classification_iterative_clustering(classes,coefficient_of_variation,'distance');
    end
