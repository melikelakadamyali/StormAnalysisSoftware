function shape_classification_iterative_distance_clustering(data)
...
if isempty(coefficient_of_variation)~=1    
    [classes,size_classes] = shape_classification_iterative_clustering(data.classes,coefficient_of_variation,'distance');
    data_classified.classes = classes;
    data_classified.name = [data.name,'iterative_clustering_distance'];
